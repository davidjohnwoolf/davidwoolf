		...
		<div className={ `content ${ slideForward ? 'f-enter' : 'b-enter' }` } id="projects">
			<div className="project-sections sections">
				...
				<section>
					<h3>Inform</h3>
					<div class="section-content">
						<h4 className="section-top-title"><a href="http://informfeedcontroller.herokuapp.com" target="_blank">Website</a> <a href="https://github.com/davidjohnwoolf/inform" target="_blank">Github</a></h4>
						<h5>Description</h5>
				...
				<section>
					<h3>Patchatech</h3>
						<div class="section-content">
						<h4 className="section-top-title"><a href="http://www.patchatech.com" target="_blank">Website</a> <a href="https://github.com/davidjohnwoolf/inform" target="_blank">Github</a></h4>
						<h5>Description</h5>
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://professionquest.herokuapp.com/login" target="_blank">Website</a> <a href="https://github.com/professionQuest/professionQuest" target="_blank">Github</a></h4>
						<h5>Description</h5>
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://ahautah.ejoinme.org/MyEvents/20172018UtahHeartBall/tabid/872317/Default.aspx" target="_blank">Website</a></h4>
						<h5>Description</h5>
				...
				<section>
					<h3>Unit Builder</h3>
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://www.nationwidetrailers.com/build-custom-pj-trailer-texas--unit-builder" target="_blank">Website</a></h4>
						<h5>Description</h5>
