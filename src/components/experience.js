		...
		<div className={ `content ${ slideForward ? 'f-enter' : 'b-enter' }` } id="experience">
			<div className="experience-sections sections">
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="http://kaizenrenewables.com" target="_blank">Dealerspike</a> <span className="dates">Dec 2016 - Jun 2018</span></h4>
						<h4>Duty</h4>
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="http://kaizenrenewables.com" target="_blank">Dealerspike</a> <span className="dates">May 2016 - Dec 2016</span></h4>
						<h4>Duty</h4>
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://www.greatergiving.com/" target="_blank">Greater Giving</a> <span className="dates">Mar 2015 - May 2016</span></h4>
						<h4>Duty</h4>
				...
				<section>
					...
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://www.lemonheaddesign.com/" target="_blank">Lemonhead Design</a> <span className="dates">Jan 2014 - August 2014</span></h4>
						<h4>Duty</h4>
				...
				<section>
					<h3>Web Developer</h3>
					<div class="section-content">
						<h4 className="section-top-title"><a href="https://github.com/davidjohnwoolf/project_bold_rails" target="_blank">Freelance</a> <span className="dates">2008 - 2014</span></h4>
						<h4>Duty</h4>
